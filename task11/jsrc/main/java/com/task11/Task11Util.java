...
public class Task11Util {
   ...
   // public static final String DYNAMODB_RESERVATION = "cmtr-2c83ab08-Reservations-test";
    ...
    public static Map<String, String> getHeaders() {
        var cors = new HashMap<String, String>();
        cors.put("Access-Control-Allow-Headers", "Content-Type,X-Amz-Date,Authorization,X-Api-Key,X-Amz-Security-Token");
        cors.put("Access-Control-Allow-Origin", "*");
        cors.put("Access-Control-Allow-Methods", "*");
        cors.put("Accept-Version", "*");
        return cors;
    }
